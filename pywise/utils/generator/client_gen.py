from pywise.utils.generator.templates import manage_client_template
from pywise.utils.fs import save_py_file
import os

def generate_client(client_output_path, endpoints):
    imports = [f"from pywise.endpoints.manage.{endpoint} import {endpoint}" for endpoint in endpoints]
