...
from pywise.endpoints.ScheduleCalendarsInfoCountEndpoint import ScheduleCalendarsInfoCountEndpoint
...
class ScheduleCalendarsInfoEndpoint(ConnectWiseEndpoint):
    ...
    def get(self, data=None, params=None) -> list[CalendarInfoModel]:
        return self._parse_many(CalendarInfoModel, super().make_request("GET", params=params))
