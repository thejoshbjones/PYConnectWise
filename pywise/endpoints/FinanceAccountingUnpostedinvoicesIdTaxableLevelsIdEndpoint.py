...
class FinanceAccountingUnpostedinvoicesIdTaxableLevelsIdEndpoint(ConnectWiseEndpoint):
    ...
    def get(self, data=None, params=None) -> UnpostedInvoiceTaxableLevelModel:
        return self._parse_one(UnpostedInvoiceTaxableLevelModel, super().make_request("GET", params=params))
