...
from pywise.endpoints.ProjectTicketsIdConfigurationsIdEndpoint import ProjectTicketsIdConfigurationsIdEndpoint
from pywise.endpoints.ProjectTicketsIdConfigurationsCountEndpoint import ProjectTicketsIdConfigurationsCountEndpoint
