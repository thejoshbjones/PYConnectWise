...
from pywise.endpoints.SystemTimeZoneSetupsInfoCountEndpoint import SystemTimeZoneSetupsInfoCountEndpoint
...
class SystemTimeZoneSetupsInfoEndpoint(ConnectWiseEndpoint):
    ...
    def get(self, data=None, params=None) -> list[TimeZoneSetupInfoModel]:
        return self._parse_many(TimeZoneSetupInfoModel, super().make_request("GET", params=params))
