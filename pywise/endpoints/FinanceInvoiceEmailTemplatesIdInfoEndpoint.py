...
class FinanceInvoiceEmailTemplatesIdInfoEndpoint(ConnectWiseEndpoint):
    ...
    def get(self, data=None, params=None) -> InvoiceEmailTemplateInfoModel:
        return self._parse_one(InvoiceEmailTemplateInfoModel, super().make_request("GET", params=params))
