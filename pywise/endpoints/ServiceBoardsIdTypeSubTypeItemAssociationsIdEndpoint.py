...
class ServiceBoardsIdTypeSubTypeItemAssociationsIdEndpoint(ConnectWiseEndpoint):
    ...
    def get(self, data=None, params=None) -> BoardTypeSubTypeItemAssociationModel:
        return self._parse_one(BoardTypeSubTypeItemAssociationModel, super().make_request("GET", params=params))
