...
class FinanceAccountingUnpostedprocurementIdTaxableLevelsIdEndpoint(ConnectWiseEndpoint):
    ...
    def get(self, data=None, params=None) -> UnpostedProcurementTaxableLevelModel:
        return self._parse_one(UnpostedProcurementTaxableLevelModel, super().make_request("GET", params=params))
