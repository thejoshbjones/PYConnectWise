...
from pywise.endpoints.ServiceTicketsIdConfigurationsIdEndpoint import ServiceTicketsIdConfigurationsIdEndpoint
from pywise.endpoints.ServiceTicketsIdConfigurationsCountEndpoint import ServiceTicketsIdConfigurationsCountEndpoint
