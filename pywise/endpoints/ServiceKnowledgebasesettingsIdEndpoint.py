...
class ServiceKnowledgebasesettingsIdEndpoint(ConnectWiseEndpoint):
    ...
    def put(self, data=None, params=None) -> KnowledgeBaseSettingsModel:
        return self._parse_one(KnowledgeBaseSettingsModel, super().make_request("PUT", params=params))
        
    def patch(self, data=None, params=None) -> KnowledgeBaseSettingsModel:
        return self._parse_one(KnowledgeBaseSettingsModel, super().make_request("PATCH", params=params))
