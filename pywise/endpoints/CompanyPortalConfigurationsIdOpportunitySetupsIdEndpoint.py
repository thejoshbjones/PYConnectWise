...
class CompanyPortalConfigurationsIdOpportunitySetupsIdEndpoint(ConnectWiseEndpoint):
    ...
    def get(self, data=None, params=None) -> PortalConfigurationOpportunitySetupModel:
        return self._parse_one(PortalConfigurationOpportunitySetupModel, super().make_request("GET", params=params))
