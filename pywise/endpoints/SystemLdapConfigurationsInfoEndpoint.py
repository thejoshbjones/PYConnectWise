...
from pywise.endpoints.SystemLdapConfigurationsInfoCountEndpoint import SystemLdapConfigurationsInfoCountEndpoint
...
class SystemLdapConfigurationsInfoEndpoint(ConnectWiseEndpoint):
    ...
    def get(self, data=None, params=None) -> list[LdapConfigurationInfoModel]:
        return self._parse_many(LdapConfigurationInfoModel, super().make_request("GET", params=params))
