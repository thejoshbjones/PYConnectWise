...
from pywise.endpoints.manage.CompanyPortalConfigurationsIdInvoiceSetupsIdTestTransactionEndpoint import CompanyPortalConfigurationsIdInvoiceSetupsIdTestTransactionEndpoint
