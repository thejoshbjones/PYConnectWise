...
from pywise.endpoints.manage.SystemMyMembersInfoEndpoint import SystemMyMembersInfoEndpoint
from pywise.models.manage.MyMemberModel import MyMemberModel
