...
from pywise.endpoints.manage.SystemAudittrailCountEndpoint import SystemAudittrailCountEndpoint
from pywise.models.manage.AuditTrailEntryModel import AuditTrailEntryModel
