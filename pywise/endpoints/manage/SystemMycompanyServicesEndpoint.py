...
from pywise.endpoints.manage.SystemMycompanyServicesIdEndpoint import SystemMycompanyServicesIdEndpoint
from pywise.models.manage.ServiceModel import ServiceModel
