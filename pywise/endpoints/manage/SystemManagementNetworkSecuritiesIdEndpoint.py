...
from pywise.endpoints.manage.SystemManagementNetworkSecuritiesIdTestCredentialsEndpoint import SystemManagementNetworkSecuritiesIdTestCredentialsEndpoint
