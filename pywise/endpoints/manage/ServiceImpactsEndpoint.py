...
from pywise.endpoints.manage.ServiceImpactsIdEndpoint import ServiceImpactsIdEndpoint
from pywise.endpoints.manage.ServiceImpactsCountEndpoint import ServiceImpactsCountEndpoint
