...
class CompanyPortalConfigurationsInvoiceSetupPaymentProcessorsIdEndpoint(ConnectWiseEndpoint):
    ...
    def get(self, data=None, params=None) -> PortalConfigurationPaymentProcessorModel:
        return self._parse_one(PortalConfigurationPaymentProcessorModel, super().make_request("GET", params=params))
