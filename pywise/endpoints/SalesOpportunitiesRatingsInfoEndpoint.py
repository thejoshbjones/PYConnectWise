...
from pywise.endpoints.SalesOpportunitiesRatingsInfoCountEndpoint import SalesOpportunitiesRatingsInfoCountEndpoint
...
class SalesOpportunitiesRatingsInfoEndpoint(ConnectWiseEndpoint):
    ...
    def get(self, data=None, params=None) -> list[OpportunityRatingInfoModel]:
        return self._parse_many(OpportunityRatingInfoModel, super().make_request("GET", params=params))
