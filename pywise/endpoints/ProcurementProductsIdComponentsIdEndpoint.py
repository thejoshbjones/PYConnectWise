...
class ProcurementProductsIdComponentsIdEndpoint(ConnectWiseEndpoint):
    ...
    def put(self, data=None, params=None) -> list[ProductComponentModel]:
        return self._parse_many(ProductComponentModel, super().make_request("PUT", params=params))
        
    def patch(self, data=None, params=None) -> list[ProductComponentModel]:
        return self._parse_many(ProductComponentModel, super().make_request("PATCH", params=params))
